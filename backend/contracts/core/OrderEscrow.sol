...
contract OrderEscrow is AccessControl {
    ...
    function placeOrderPayableEth(string calldata /* orderRef */) external payable returns (uint256 orderId) {
        require(msg.value > 0, "Amount must be > 0");
        orderId = ++nextOrderId;

        orders[orderId] = Order({
            customer: msg.sender,
            restaurant: address(0), // Placeholder for demo
            driver: address(0),     // Placeholder for demo
            amount: msg.value,
